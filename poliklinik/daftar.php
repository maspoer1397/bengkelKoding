    ...
    <div class="container mt-3">
        <div class="mx-auto p-2 border" style="width: 500px;">
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    <label for="c_password" class="form-label"><b>Konfirmasi Password</b></label>
                    <input type="password" class="form-control" id="almt_dktr" placeholder="Password" name="c_pass">
                </div>
