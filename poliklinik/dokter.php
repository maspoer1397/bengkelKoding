        ...
        <div class="container mt-3">
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="no_dktr" placeholder="masukan nama" name="no_dktr">
                </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>
                        ...
                        <a class="btn btn-danger" href="dokter.php?id=<?= $dokter['id'];?>&action=delete">Hapus</a>
                    </th>
                </tr>
                <?php } ?>
            </tbody>
